...
function ProjectFormModal({
  ...
  const { mutate: addProject, isLoading: loadAddingProject } = useAddProject();
  const { mutate: updateProject, isLoading: loadUpdateProject } =
    useUpdateProject();
  ...
  const handleSubmit = async (
    ...
    if (type == "ADD") {
      ...
      updateProject({
        ...
        name: formData.name,
        deployed_link: formData.deployedLink,
      ...
      <div className="overlay  absolute top-0 left-0 z-50 w-[100vw] h-[100vh]   flex items-center  justify-center  ">
        ...
        >
          ...
          <div className="flex  flex-col gap-2 mt-2 justify-center items-center">
            <div className="flex ">
              {updateData?.project_pic ? (
                <>
                  <img
                    src={updateData.project_pic}
                    className="h-[4rem] w-[6rem] "
                  />
                </>
              ) : formData.project_pic === null ? (
                <img
                  src={unknown}
                ...
                <>
                  {" "}
                  <img
                    src={URL.createObjectURL(formData.project_pic)}
